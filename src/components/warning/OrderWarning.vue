...
export default {
  ...
  created() {
    axios.get("getOrderWarning").then(res => {
      this.tableData = res.data
    })
  },
  methods: {
    change() {
      axios.post("getOrderWarningDynamic", QS.stringify({
        info: this.info,
    ...
    editClick(row) {
      axios.post("updateOrderWarning", QS.stringify({
